...
Analytics.updateEndpoint({
    address: 'shogo.kusuhara@gmail.com', // The unique identifier for the recipient. For example, an address could be a device token, email address, or mobile phone number.
    attributes: {
        // Custom attributes that your app reports to Amazon Pinpoint. You can use these attributes as selection criteria when you create a segment.
        hobbies: ['gaming', 'coding', 'blog', 'D2C'],
    },
    ...
    demographic: {
        ...
        timezone: 'Asia/Tokyo' // The timezone of the endpoint. Specified as a tz database value, such as Americas/Los_Angeles.
    },
    location: {
        city: '大阪市', // The city where the endpoint is located.
        country: '日本', // The two-letter code for the country or region of the endpoint. Specified as an ISO 3166-1 alpha-2 code, such as "US" for the United States.
        ...
        postalCode: '544-0025', // The postal code or zip code of the endpoint.
        region: '関西' // The region of the endpoint location. For example, in the United States, this corresponds to a state.
    },
    metrics: {
    ...
    */
    optOut: 'ALL',
    // Customized userId
    userId: '192-1294-3924',
    // User attributes
    userAttributes: {
        interests: ['football', 'basketball', 'AWS'],
        brands: ['Rady', 'Michelmacaron'],
        social: ['LINE', 'instagram']
        // ...
    }
}).then(() => {
    console.log('ユーザーのエンドポイントをアップデートしました')
});